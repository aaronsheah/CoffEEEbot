...
(cl:defmethod cl:initialize-instance :after ((m <question_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'question_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_machine-msg:<question_msg> is deprecated: use state_machine-msg:question_msg instead.")))
