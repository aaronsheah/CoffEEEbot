...
(cl:defmethod cl:initialize-instance :after ((m <RecMsgStruc>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecMsgStruc)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_machine-msg:<RecMsgStruc> is deprecated: use state_machine-msg:RecMsgStruc instead.")))

(cl:ensure-generic-function 'Name-val :lambda-list '(m))
(cl:defmethod Name-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:Name-val is deprecated.  Use state_machine-msg:Name instead.")
  (Name m))

(cl:ensure-generic-function 'userID-val :lambda-list '(m))
(cl:defmethod userID-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:userID-val is deprecated.  Use state_machine-msg:userID instead.")
  (userID m))

(cl:ensure-generic-function 'isExist-val :lambda-list '(m))
(cl:defmethod isExist-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:isExist-val is deprecated.  Use state_machine-msg:isExist instead.")
  (isExist m))

(cl:ensure-generic-function 'FirstRec-val :lambda-list '(m))
(cl:defmethod FirstRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:FirstRec-val is deprecated.  Use state_machine-msg:FirstRec instead.")
  (FirstRec m))

(cl:ensure-generic-function 'FirstQ-val :lambda-list '(m))
(cl:defmethod FirstQ-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:FirstQ-val is deprecated.  Use state_machine-msg:FirstQ instead.")
  (FirstQ m))

(cl:ensure-generic-function 'SecondRec-val :lambda-list '(m))
(cl:defmethod SecondRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:SecondRec-val is deprecated.  Use state_machine-msg:SecondRec instead.")
  (SecondRec m))

(cl:ensure-generic-function 'SecondQ-val :lambda-list '(m))
(cl:defmethod SecondQ-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:SecondQ-val is deprecated.  Use state_machine-msg:SecondQ instead.")
  (SecondQ m))

(cl:ensure-generic-function 'ThirdRec-val :lambda-list '(m))
(cl:defmethod ThirdRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:ThirdRec-val is deprecated.  Use state_machine-msg:ThirdRec instead.")
  (ThirdRec m))

(cl:ensure-generic-function 'ThirdQ-val :lambda-list '(m))
(cl:defmethod ThirdQ-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:ThirdQ-val is deprecated.  Use state_machine-msg:ThirdQ instead.")
  (ThirdQ m))

(cl:ensure-generic-function 'ForthRec-val :lambda-list '(m))
(cl:defmethod ForthRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:ForthRec-val is deprecated.  Use state_machine-msg:ForthRec instead.")
  (ForthRec m))

(cl:ensure-generic-function 'FifthRec-val :lambda-list '(m))
(cl:defmethod FifthRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:FifthRec-val is deprecated.  Use state_machine-msg:FifthRec instead.")
  (FifthRec m))
