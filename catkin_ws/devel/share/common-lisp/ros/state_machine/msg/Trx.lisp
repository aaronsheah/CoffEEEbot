...
(cl:defmethod cl:initialize-instance :after ((m <Trx>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trx)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_machine-msg:<Trx> is deprecated: use state_machine-msg:Trx instead.")))
...
(cl:defmethod keep-val ((m <Trx>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:keep-val is deprecated.  Use state_machine-msg:keep instead.")
  (keep m))

(cl:ensure-generic-function 'drink-val :lambda-list '(m))
(cl:defmethod drink-val ((m <Trx>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader state_machine-msg:drink-val is deprecated.  Use state_machine-msg:drink instead.")
  (drink m))
