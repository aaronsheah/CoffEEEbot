...
(cl:defmethod cl:initialize-instance :after ((m <Trx>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trx)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-msg:<Trx> is deprecated: use test-msg:Trx instead.")))
...
(cl:defmethod keep-val ((m <Trx>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:keep-val is deprecated.  Use test-msg:keep instead.")
  (keep m))

(cl:ensure-generic-function 'drink-val :lambda-list '(m))
(cl:defmethod drink-val ((m <Trx>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:drink-val is deprecated.  Use test-msg:drink instead.")
  (drink m))
