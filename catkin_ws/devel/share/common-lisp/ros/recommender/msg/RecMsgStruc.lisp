...
(cl:defmethod cl:initialize-instance :after ((m <RecMsgStruc>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecMsgStruc)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name recommender-msg:<RecMsgStruc> is deprecated: use recommender-msg:RecMsgStruc instead.")))
...
(cl:defmethod FirstRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:FirstRec-val is deprecated.  Use recommender-msg:FirstRec instead.")
  (FirstRec m))

(cl:ensure-generic-function 'FirstQ-val :lambda-list '(m))
(cl:defmethod FirstQ-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:FirstQ-val is deprecated.  Use recommender-msg:FirstQ instead.")
  (FirstQ m))

(cl:ensure-generic-function 'SecondRec-val :lambda-list '(m))
(cl:defmethod SecondRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:SecondRec-val is deprecated.  Use recommender-msg:SecondRec instead.")
  (SecondRec m))

(cl:ensure-generic-function 'SecondQ-val :lambda-list '(m))
(cl:defmethod SecondQ-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:SecondQ-val is deprecated.  Use recommender-msg:SecondQ instead.")
  (SecondQ m))

(cl:ensure-generic-function 'ThirdRec-val :lambda-list '(m))
(cl:defmethod ThirdRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:ThirdRec-val is deprecated.  Use recommender-msg:ThirdRec instead.")
  (ThirdRec m))

(cl:ensure-generic-function 'ThirdQ-val :lambda-list '(m))
(cl:defmethod ThirdQ-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:ThirdQ-val is deprecated.  Use recommender-msg:ThirdQ instead.")
  (ThirdQ m))

(cl:ensure-generic-function 'ForthRec-val :lambda-list '(m))
(cl:defmethod ForthRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:ForthRec-val is deprecated.  Use recommender-msg:ForthRec instead.")
  (ForthRec m))

(cl:ensure-generic-function 'FifthRec-val :lambda-list '(m))
(cl:defmethod FifthRec-val ((m <RecMsgStruc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader recommender-msg:FifthRec-val is deprecated.  Use recommender-msg:FifthRec instead.")
  (FifthRec m))
