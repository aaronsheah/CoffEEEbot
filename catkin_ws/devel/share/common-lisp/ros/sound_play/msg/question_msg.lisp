...
(cl:defmethod cl:initialize-instance :after ((m <question_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'question_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sound_play-msg:<question_msg> is deprecated: use sound_play-msg:question_msg instead.")))

(cl:ensure-generic-function 'dialogue-val :lambda-list '(m))
(cl:defmethod dialogue-val ((m <question_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sound_play-msg:dialogue-val is deprecated.  Use sound_play-msg:dialogue instead.")
  (dialogue m))

(cl:ensure-generic-function 'ans-val :lambda-list '(m))
(cl:defmethod ans-val ((m <question_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sound_play-msg:ans-val is deprecated.  Use sound_play-msg:ans instead.")
  (ans m))

(cl:ensure-generic-function 'stock-val :lambda-list '(m))
(cl:defmethod stock-val ((m <question_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sound_play-msg:stock-val is deprecated.  Use sound_play-msg:stock instead.")
  (stock m))
