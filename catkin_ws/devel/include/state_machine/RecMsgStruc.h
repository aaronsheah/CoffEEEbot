// Generated by gencpp from file state_machine/RecMsgStruc.msg
// DO NOT EDIT!


#ifndef STATE_MACHINE_MESSAGE_RECMSGSTRUC_H
#define STATE_MACHINE_MESSAGE_RECMSGSTRUC_H
...
struct RecMsgStruc_
{
  ...
  typedef boost::shared_ptr< ::state_machine::RecMsgStruc_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::state_machine::RecMsgStruc_<ContainerAllocator> const> ConstPtr;

}; // struct RecMsgStruc_

typedef ::state_machine::RecMsgStruc_<std::allocator<void> > RecMsgStruc;

typedef boost::shared_ptr< ::state_machine::RecMsgStruc > RecMsgStrucPtr;
typedef boost::shared_ptr< ::state_machine::RecMsgStruc const> RecMsgStrucConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::state_machine::RecMsgStruc_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::state_machine::RecMsgStruc_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::state_machine::RecMsgStruc_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::state_machine::RecMsgStruc_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::state_machine::RecMsgStruc_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::state_machine::RecMsgStruc_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::state_machine::RecMsgStruc_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::state_machine::RecMsgStruc_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::state_machine::RecMsgStruc_<ContainerAllocator> >
{
  ...
  static const char* value(const ::state_machine::RecMsgStruc_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfb202545eccded8bULL;
  static const uint64_t static_value2 = 0x9b08c3c358605781ULL;
};

template<class ContainerAllocator>
struct DataType< ::state_machine::RecMsgStruc_<ContainerAllocator> >
{
  static const char* value()
  {
    return "state_machine/RecMsgStruc";
  }
...
template<class ContainerAllocator>
struct Definition< ::state_machine::RecMsgStruc_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string Name\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::state_machine::RecMsgStruc_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::state_machine::RecMsgStruc_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::state_machine::RecMsgStruc_<ContainerAllocator>& v)
  {
    s << indent << "Name: ";
...
#endif // STATE_MACHINE_MESSAGE_RECMSGSTRUC_H
