...
public:
	...
	out_of_stock[4]=0;
        ...
        privacyPub= n.advertise<state_machine::question_msg>("privacy", bufferSize);
...
void FSM::state5(){
    ...
    ss<<"You want a Caramel Latte Macchiato?\n";
    msg.dialogue =ss.str();
    msg.ans=2;
    msg.stock=0;
...
void FSM::state11(){
    ...
    ss<<"I am really sorry, could you repeat your choice?\n";
    msg.dialogue =ss.str();
    msg.ans=1;
    msg.stock=stock;
